...
/**
 * /account grew into /settings — its two cards (password, recovery phrase) live on the
 * Security & data page there. The route stays as a redirect because the address has been the
