...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'mobile',
      testMatch: /(availability|compose|csp|legal|grid-interactions|holidays|hotkeys|landing|leak|nav-feel|people|plan|prelaunch|view-as|edit-event|delete-event|fallbacks|settings|shell|visibility-sheet|views)\.spec\.ts/,
      use: { ...devices['Pixel 7'] },
    },
    {
      name: 'desktop',
