...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'mobile',
      testMatch: /(availability|billing|block-legibility|cloak-transition|compose|contact|csp|export|legal|grid-interactions|holidays|hotkeys|landing|leak|loading-continuity|nav-feel|people|plan|prelaunch|view-as|edit-event|delete-event|fallbacks|settings|shell|visibility-sheet|views)\.spec\.ts/,
      use: { ...devices['Pixel 7'] },
    },
    {
      name: 'desktop',
