...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'mobile',
      testMatch: /(compose|grid-interactions|hotkeys|landing|leak|nav-feel|people|prelaunch|view-as|edit-event|delete-event|fallbacks|settings|shell|visibility-sheet|views)\.spec\.ts/,
      use: { ...devices['Pixel 7'] },
    },
    {
      name: 'desktop',
